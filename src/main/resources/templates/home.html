    ...
    <section id="about">
        <div class="container px-4">
            <div class="row gx-4 mt-5 justify-content-center">
                <div class="col-lg-8">
                    <h2> About </h2>
                    <p class="lead"> Michael's Petitions is the world's largest tech platform for social change. Over a million people across 90 countries use our petition platform to speak up on issues that they're passionate about. 2,000 petitions are created on Michael's Petitions every day. We provide support for: </p>
                    <ul>
                        <li> Viewing active petitions </li>
                        <li> Signing petitions </li>
                        <li> Creating petitions </li>
                        <li> Searching petitions </li>
                    </ul>
                </div>
            </div>
        </div>
